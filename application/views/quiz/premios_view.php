...
<html lang="en">
	...
	<body onload="FB.Canvas.setSize({
		...
		<div class="container">
			<div id="nav"><div>
					<?= anchor('quiz/registro', 'Participa', '') ?>
					<?= anchor('quiz/premios', 'Premios', 'class="active"') ?>
				</div></div>
			<div id="participaya">
				<?= anchor('quiz/participa', img(array('src' => 'public/img/quiz/participaya.png', 'alt' => 'Participa')), 'class="participa_btn"') ?>
				<div id="copy">
